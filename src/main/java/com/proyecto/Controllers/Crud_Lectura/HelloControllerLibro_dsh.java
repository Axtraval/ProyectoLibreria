...
public class HelloControllerLibro_dsh {
    ...
    private void cargarLibrosPredeterminados() {
        ...
        listaMostrar.add(new Lectura("El Nombre del Viento", "Patrick Rothfuss", "Fantasia", 700, 2007));
        listaMostrar.add(new Lectura("La Quinta Estacion", "N.K. Jemisin", "Fantasia", 650, 2015));
        listaMostrar.add(new Lectura("El Temor de un Hombre Sabio", "Patrick Rothfuss", "Fantasia", 750, 2011));
        listaMostrar.add(new Lectura("Dune", "Frank Herbert", "Ciencia Ficcion", 850, 1965));
        listaMostrar.add(new Lectura("Neuromante", "William Gibson", "Ciencia Ficcion", 600, 1984));
        listaMostrar.add(new Lectura("Fundacion", "Isaac Asimov", "Ciencia Ficcion", 700, 1951));
        listaMostrar.add(new Lectura("El Codigo Da Vinci", "Dan Brown", "Misterio", 650, 2003));
        listaMostrar.add(new Lectura("La Chica del Tren", "Paula Hawkins", "Misterio", 600, 2015));
        listaMostrar.add(new Lectura("Asesinato en el Orient Express", "Agatha Christie", "Misterio", 550, 1934));
        listaMostrar.add(new Lectura("Bajo la Misma Estrella", "John Green", "Romance", 500, 2012));
        listaMostrar.add(new Lectura("El Cuaderno de Noah", "Nicholas Sparks", "Romance", 550, 1996));
        listaMostrar.add(new Lectura("Orgullo y Prejuicio", "Jane Austen", "Romance", 450, 1813));
        listaMostrar.add(new Lectura("It", "Stephen King", "Terror", 1100, 1986));
        listaMostrar.add(new Lectura("El Exorcista", "William Peter Blatty", "Terror", 800, 1971));
        listaMostrar.add(new Lectura("Cementerio de Animales", "Stephen King", "Terror", 900, 1983));
    }
    ...
    protected void onPublicarClick() {
        try {
            ...
            if (!titulo.isEmpty() && !autor.isEmpty() && !genero.isEmpty()) {
                ...
                listaLibroDshes.setAll(servicio.listar());
                listaMostrar.add(new Lectura(titulo, autor, genero, puntos, anio));
                limpiarCampos();
