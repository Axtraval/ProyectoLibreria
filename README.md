# | **TECMILENIO** | HOJA DE PRESENTACIÓN |
---
## **Carrera:** Ingeniería en Desarrollo de Software
## **Materia:** Programación Orientada a Objetos
## **Equipo:**  Fernando Riquelme Cruz Jiménez - Alex Omar Chablé Acosta  - Braulio Rojas Espino - Dasha Guzman Ramon - Braulio Jesús García Jiménez - Erik Daniel Ruiz Moreno

## **Profesor:** Juan Manuel Herrera Carrera
---
# **FUNCIONALIDADES (AL MOMENTO)**
## 1. CRUD DE ACCESO AL PROGRAMA
## 2. CRUD DEL PUBLICADOR (PUBLICAR, MODIFICAR, ELIMINAR)
## 3. INTERFAZ GRÁFICA DE AMBOS CRUD´S
...
## 1. CRUD DEL LECTOR
## 2. MEJORAR LA GUI 
## 3. CONECTAR LAS VENTANAS 
## 4. ORGANIZAR LA ESTRUCTURA DEL PROYECTO (PACKAGES)
